...
export default function(amp: PluginAPI) {
	...
	// Final tool list for this agent (overrides + additions)
	const SMART_TOOL_NAMES = [
		...
		'create_file',
		'edit_file',
		'web_search',           // overridden by Firecrawl above
		'read_web_page',        // overridden by Firecrawl above
		'firecrawl_map',
		'firecrawl_crawl',
		'firecrawl_agent',
		'firecrawl_browser',
	...
	amp.experimental.registerAgentMode({
		key: 'grok',
		label: 'Grok',
		description: 'Grok Build 0.1 agent mode with Firecrawl web tools (overrides + additions).',
		color: '#ea580c',
